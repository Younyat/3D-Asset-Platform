...
async function readTextFile(path, options) {
  ...
  return new TextDecoder((options == null ? void 0 : options.encoding) ?? "utf-8").decode(bytes);
}
async function readTextFileLines(path, options) {
  ...
  return await Promise.resolve({
    ...
    rid: null,
    async next() {
      const decoder = new TextDecoder((options == null ? void 0 : options.encoding) ?? "utf-8");
      if (this.rid === null) {
